...
extension String {
    public func getStringSize(_ fontSize: CGFloat) -> CGSize {
        let font: UIFont = UIFont.fontWithHelvetica(fontSize)
    ...
    public func getStringSize(_ fontSize: CGFloat, _ maxBorderWidth: CGFloat) -> CGSize {
        let font: UIFont = UIFont.fontWithHelvetica(fontSize)
        let height: CGFloat = font.lineHeight
        let maxRect = CGSize(width: CGFloat(MAXFLOAT), height: height)
        let attributes = [NSAttributedString.Key.font: font as Any]
